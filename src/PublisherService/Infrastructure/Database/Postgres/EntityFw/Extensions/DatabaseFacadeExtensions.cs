...
public static class DatabaseFacadeExtensions
{
    ...
    public static IDbContextTransaction BeginTransaction(this DatabaseFacade database, IOutboxPublisher? outboxPublisher = null)
    {
    ...
    public static IDbContextTransaction BeginTransaction(this DatabaseFacade database, IsolationLevel isolationLevel, IOutboxPublisher? outboxPublisher = null)
    {
